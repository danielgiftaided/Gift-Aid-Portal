                ...
                <div className="text-center mb-5">
                  ...
                  {showSecret && (
                    <div className="mt-2 bg-gray-50 rounded-lg p-3">
                      <p className="text-xs text-gray-400 mb-1">Enter this key in your authenticator app:</p>
                      <p className="font-mono text-sm font-bold text-brand-primary tracking-widest break-all">{secret}</p>
                    </div>
                  )}
                </div>
